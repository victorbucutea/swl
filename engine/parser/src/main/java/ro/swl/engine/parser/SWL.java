...
public class SWL/* @bgen(jjtree) */implements SWLTreeConstants, SWLConstants {/*
																			 * @bgen
																			 * (
																			 * jjtree
																			 * )
	...
	final public void GenericBlock(int switchBackState) throws ParseException {
	...
	final public String ButtonActionParameter() throws ParseException {
		trace_call("ButtonActionParameter");
		try {
			...
			trace_return("ButtonActionParameter");
		}
	}
	...
	final public ASTLogic Logic() throws ParseException {
		trace_call("Logic");
		try {
			/* @bgen(jjtree) Logic */
			...
			try {
				...
				jj_consume_token(OPEN_BRACKET);
				token_source.SwitchTo(LogicState);
				label_15: while (true) {
					switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
					case SERVICE:
					case EXTERNAL:
	...
	final public void ExternalInterface() throws ParseException {
		trace_call("ExternalInterface");
		try {
			...
			try {
				...
				switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
				case EXT_IF_REST:
					t = jj_consume_token(EXT_IF_REST);
					break;
				case EXT_IF_FORM:
					t = jj_consume_token(EXT_IF_FORM);
					break;
				case EXT_IF_FILE:
					t = jj_consume_token(EXT_IF_FILE);
					break;
				case EXT_IF_WS:
					t = jj_consume_token(EXT_IF_WS);
					break;
				case EXT_IF_EMAIL:
					t = jj_consume_token(EXT_IF_EMAIL);
					break;
				default:
					jj_la1[55] = jj_gen;
					jj_consume_token(-1);
			...
			trace_return("ExternalInterface");
		}
	}


	final public void ExchangeModel() throws ParseException {
		trace_call("ExchangeModel");
		try {
			...
			trace_return("ExchangeModel");
		}
	}


	final public void ServiceActions() throws ParseException {
		trace_call("ServiceActions");
		try {
	...
	final public void Service() throws ParseException {
		...
		try {
			...
			trace_return("Service");
		}
	}


	final public void Crud() throws ParseException {
		trace_call("Crud");
		try {
			/* @bgen(jjtree) Crud */
			...
			Token t;
			try {
				jj_consume_token(CRUD);
				t = jj_consume_token(S_NAME);
				jjtn000.setEntity(t.image);
				jj_consume_token(OPEN_BRACKET);
				label_19: while (true) {
					switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
					case SEARCHER:
	...
	final public void Searcher() throws ParseException {
		trace_call("Searcher");
		try {
			...
			Token t3;
			try {
				jj_consume_token(SEARCHER);
				t2 = jj_consume_token(S_NAME);
				jjtn000.setSearcherName(t2.image);
				jj_consume_token(OPEN_BRACKET);
				t3 = jj_consume_token(S_QUOTED_TEXT);
				jjtn000.setQuery(t3.image);
				jj_consume_token(CLOSE_BRACKET);
			} finally {
				if (jjtc000) {
					jjtree.closeNodeScope(jjtn000, true);
	...
	final public void Action() throws ParseException {
		...
		try {
			...
			try {
				...
				case S_NAME:
					type = Type();
					jjtn000.setReturnType(type);
					break;
				case VOID:
					jj_consume_token(VOID);
					jjtn000.setVoid(true);
					break;
				default:
					jj_la1[63] = jj_gen;
					jj_consume_token(-1);
				...
				t1 = jj_consume_token(S_NAME);
				jjtn000.setImageWithoutQuote(t1.image);
				jj_consume_token(OPEN_R_BRACKET);
				switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
				case S_PRIMITIVE:
				case S_COLLECTION:
	...
	final public ASTType Type() throws ParseException {
		...
		try {
			...
			try {
				switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
				case S_PRIMITIVE:
					t2 = jj_consume_token(S_PRIMITIVE);
					jjtn000.setPrimitive(true);
					break;
				case S_COLLECTION:
					t2 = jj_consume_token(S_COLLECTION);
					jj_consume_token(S_OPEN_ANGLE);
					t3 = jj_consume_token(S_NAME);
					jj_consume_token(S_CLOSE_ANGLE);
					break;
				case S_NAME:
					t2 = jj_consume_token(S_NAME);
					break;
	...
	final public void ActionParam() throws ParseException {
		trace_call("ActionParam");
		try {
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x80000, 0x800000, 0x200000, 0x100000, 0x400000, 0x80, 0x80, 0x2000000, 0x1000000,
				0xe0000000, 0xe0000000, 0x2000000, 0x1000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x200, 0x200, 0x200, 0x200,
				0x200, 0x80, 0x200, 0x200, 0x200, 0x200, 0x0, 0x200, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	...
	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x100000, 0x100000, 0x0, 0x0, 0x4bfd3, 0x4bfd3, 0x0, 0x0,
				0x10000, 0x20000, 0x800000, 0x50000, 0x40000, 0x40000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x100, 0x0, 0x800000, 0x400000, 0x800000, 0x400000, 0x1000000, 0x1000000, 0x2400000, 0x4000000,
				0x800000, 0x2400000, 0x800000, 0x2400000, 0x800000, 0x2400000, 0xc, 0xc, 0x4, 0x800000, 0x2400000,
				0x48000000, 0x48000000, 0x40000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	...
	private static void jj_la1_init_2() {
		jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2001000, 0x2001000,
				0x3e0000, 0x800000, 0x400f000, 0x400f000, 0x10, 0x400e400, 0x400e400, 0x800, 0x400e000, 0x10000,
				0x4006000, 0x4006000, 0x12, 0x12, 0x40, 0x40, 0x1c, 0x90, 0x20, };
	}
	...
	private void jj_add_error_token(int kind, int pos) {
		...
		if (pos == (jj_endpos + 1)) {
			...
			jj_entries_loop: for (Object name2 : jj_expentries) {
				int[] oldentry = (int[]) (name2);
