...
import static ${package}.${rootArtifactId}.base.util.ReflectionUtil.getAllFieldsAsMap;
import static ${package}.${rootArtifactId}.base.util.ReflectionUtil.getFieldValue;
import static ${package}.${rootArtifactId}.base.util.ReflectionUtil.setFieldValue;
...
public class ReflectionEntityMapper implements Mapper {
	...
	public void map(Collection<Entity> managedCollection, Collection<Entity> deserializedCollection) {
		...
		for (Entity deserializedObj : deserializedCollection) {
			...
			if (managedCollection.contains(deserializedObj)) {
				for (Entity managedObj : managedCollection) {
