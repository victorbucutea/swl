...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.${rootArtifactId}.test.cv.dao;
...
import ${package}.${rootArtifactId}.interview.model.Certification;
import ${package}.${rootArtifactId}.interview.model.CompanyType;
import ${package}.${rootArtifactId}.interview.model.Education;
import ${package}.${rootArtifactId}.interview.model.Experience;
import ${package}.${rootArtifactId}.interview.model.Project;
