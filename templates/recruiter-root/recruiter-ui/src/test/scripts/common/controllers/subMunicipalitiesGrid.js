		...
		function() {
			...
			return function($scope) {
				...
				function imageFormat(cellvalue, options, rowObject) {
					return '<a href><span style="overflow: ellipsis;width: 80%;" class="ng-binding">' + cellvalue + '</span><i ng-click="" class="icon-folder-open new-tab"></i></a>';
				}
							...
							.jqGrid(
									{
										...
										width : "auto",
//										rowNum : 10,
										colNames : [ "Fused municipality", "Sub-municipality"],
										colModel : [
