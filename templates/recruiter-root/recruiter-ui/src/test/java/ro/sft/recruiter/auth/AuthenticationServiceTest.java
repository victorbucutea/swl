...
import ro.sft.recruiter.RestExceptionMapper;
...
import ro.sft.recruiter.user.UserService;
import ro.sft.recruiter.user.UserServiceBean;
import ro.sft.recruiter.user.model.Group;
import ro.sft.recruiter.user.model.Role;
...
public class AuthenticationServiceTest extends DaoTest {
	...
	public void exceptionMapper_servletExceptionMapped() throws URISyntaxException {
		...
		MockHttpResponse response = invokePostUri(reqStr, "{\"name\":\"asd\",\"password\":\"asd\"}", false);
